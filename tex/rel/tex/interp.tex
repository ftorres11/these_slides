...
\begin{frame}[t]
    ...
    \begin{columns}
        ...
        \column[T]{.6\textwidth}
            {\scriptsize%
                \begin{itemize}
                    \item  Measurements between the predicted object bounding box and object bounding 
                    boxes (OM, LE, F$_1$).
                    \item Overlapping between largest connected bounding box and object bounding box (BA).
                    \item Existence of the most salient points and the fraction of the map with the bounding box (EP, SP).
                    \item Penalty of size of the bounding box with entropy and image size (SM).                        
                \end{itemize}
            }
    \end{columns}
\end{frame}
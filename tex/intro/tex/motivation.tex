...
%            \node (img_in) at (0, 1.25) {\includegraphics[scale=0.15]
...
%            \node (img_shoe_raw) at (3.5,1.45) {\includegraphics[scale=0.125]
 ...
 \begin{frame}[t]
    ...
    \begin{columns}[t]
        ...
        \column[T]{0.5\textwidth}
            ...
            \end{itemize}
            \small We must \textbf{understand} the behaviour of these models.
        \end{columns}
 \end{frame}
 %--------------------------------------------------------------------------------------------------
\begin{frame}

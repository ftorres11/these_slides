...
%    \centering
\resizebox{\textwidth}{!}{%
    \begin{tikzpicture}[font={\footnotesize},trap/.style={trapezium, rotate=-90,trapezium angle=75, fill=red!5, opacity=.5},]
        %% CNN branch
        \node(input) at (-5.5, 0) {\includegraphics[width=.1\textwidth]{fig/castream/img/input.jpg}};
        \node[above] at (input.north) {Input image $\vx$};
        \node[draw, trap] (res0) at (-3.5,0) {\rotatebox{90}{\parbox{1.0cm}{\centering{Transf-0}}}};
        \node[draw, trap] (res1) at (-1.5,0) {\rotatebox{90}{\parbox{1.0cm}{\centering{Transf-1}}}};
        \node[draw, trap] (res2) at (0.5,0) {\rotatebox{90}{\parbox{1.0cm}{\centering{Transf-2}}}};
        \node[draw, trap] (res3) at (2.5,0) {\rotatebox{90}{\parbox{1.0cm}{\centering{Transf-3}}}};
        \node[draw, trap] (res4) at (4.5,0) {\rotatebox{90}{\parbox{1.0cm}{\centering{Transf-4}}}};
        \node[](empt1) at (6.75, 0){};
        ...
        \draw[->] (res4) -- node {} (class);
        \node[](GAP) at (6.25,0.25) {\textsc{CLS}};

...
\date[2024] % (optional)
{\small Marseille, Septembre 23 2024}
\logo{%
...
\begin{document}
  ...
  \begin{frame}[plain]
    ...
    \vspace{-20pt}
    {\scriptsize
    {\centering\itshape Membres de jury\par}
    Prèsident: Fr\'ed\'eric Jurie
    \begin{tabular}[t]{@{}l@{\hspace{3pt}}p{.32\textwidth}@{}}
    Examinateurs: & Fr\'ed\'eric Jurie \\
    & Giorgos Tolias \\
    Rapporteurs:& Fr\'ed\'eric Precioso \\
    & Diane Larlus
    \end{tabular}%
    %\scriptsize
    \begin{tabular}[t]{@{}l@{\hspace{3pt}}p{.3\textwidth}@{}}
    Superviseurs: & St\'ephane Ayache \\
     & Ronan Sicre \\
     & Yannis Avrithis
    \end{tabular}
    }%
